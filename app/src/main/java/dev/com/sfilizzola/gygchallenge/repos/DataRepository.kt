...
class DataRepository @Inject constructor(private var service: NetworkClient,
    ...
    fun getReviews(totalPerPage: Int, currentPage: Int, rating: Int, sortBy: String, sortDirection: String): Single<List<Review>> {
        return service.getReviews(reviewsCount = totalPerPage, pageIndex = currentPage, rating = rating, sortingType = sortBy, sortingDirection = sortDirection)
                .flatMapPublisher {
